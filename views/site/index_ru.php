...
$this->context->addUrl = '';
$this->title = 'Запчасти для спецтехники - купить в Москве: продажа деталей строительной техники и погрузчиков';
$this->registerMetaTag(
    ['name' => 'description', 'content' => 'Купить запчасти для спецтехники в Москве ➔ Доставка по всей России ➔ Подбор запасных деталей ➔ Низкие цены на комплекты ➔ Гарантия на все детали ☎ +7 499 450-25-44']
);
