                ...
                <div class="grid_12 clearfix">
                    <div class="fleft">
                        ...
                        <div class="lang-block">
                            <span class="lang-link">ENG <i class="fa fa-chevron-down"></i></span>
                            <ul>
                                <li><a href="/" class="lang-link">RUS</a></li>
                            </ul>
                        </div>
                    </div>
                    <a href="#calc" class="calc-link go_to" style="padding: 5px 20px;height: auto;">CLICK HERE FOR
                        CHECKING OUT THE SPARE PART</a>
                    <div class="fright">
                        <div class="block-1">
                            <div class="adress-block">
                                <img src="/images/flag_ru.svg" alt="adress-img">
                                <div class="adress-info">
                                    <p class="info"><span><i class="fa fa-map-marker"></i> OUR OFFICE IN RUSSIA:</span>
                                        <a href="tel:+74994502544" class="phone-link">+7 499 450-25-44</a></p>
                            ...
                            <div class="adress-block">
                                ...
                                <div class="adress-info">
                                    <p class="info"><span><i class="fa fa-map-marker"></i> OUR OFFICE IN THE UNITED STATES:</span>
                                        <a href="tel:17328935295" class="phone-link">1-732-8935295</a></p>
